        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 col-md-6 social-style-2 text-center text-md-left">
                    ...
                    <a href="index.html"><img class="footer-logo" src="{{ asset('public/assets/theme/pofo/default/images/logo.png') }}" data-rjs="{{ asset('public/assets/theme/pofo/default/images/logo@2x.png') }}" alt="Pofo"></a>
                    <!-- end logo -->
                    <!-- start social media -->
