...
@section('styles')
{{-- {{ Html::style('public/assets/theme/pofo/customize/css/style.css?v='.date('Y-m-d H:i')) }} --}}
@endsection
                ...
                <div class="slider-text-middle">
                    <div class="bg-black-opacity-light w-50 mx-auto md-width-80">
                        <div class="padding-fifteen-all sm-padding-20px-all">
                            ...
                            <a href="index.html" class="btn btn-transparent-white btn-medium text-extra-small border-radius-4"><i class="ti-arrow-left margin-5px-right ml-0" aria-hidden="true"></i> Back To Homepage</a>
                        </div>
                    </div>
                </div>
            </div>
